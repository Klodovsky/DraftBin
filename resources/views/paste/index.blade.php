...
@section('pagetitle') Home | DraftBin @endsection
...
@else
	<li class="nav-item"><a href="{{url('showPublicNotes')}}" class="nav-link">Public Post</a></li>
	...
	<form action="/" method="post" accept-charset="utf-8">
		...
		<div class="row">
			<div class="form-group col-xs-12 @if ($errors->has('pasteTitle')) has-error @endif">
				...
				<input type="text" class="form-control" name="pasteTitle" id="pasteTitle" placeholder="Title (optional)" maxlength="20" value="{{ old('pasteTitle') }}">
